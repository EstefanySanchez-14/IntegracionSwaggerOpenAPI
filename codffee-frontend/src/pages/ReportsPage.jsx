...
function ReportsPage() {
  ...
  const handleDescargarFiltrado = async () => {
    if (!fechaInicio || !fechaFin) {
      Swal.fire({ icon: 'warning', title: 'Campos requeridos', text: 'Selecciona fecha inicio y fecha fin' })
      return
    }
    ...
    try {
      ...
      Swal.fire({ icon: 'error', title: 'Error', text: 'No se pudo descargar el reporte filtrado' })
    }
  }
  ...
  return (
    <main className="reports-page">
      <header className="reports-header">
        ...
        <button className="btn-codffee-outline reports-download-btn" onClick={handleDescargarGeneral}>
      ...
      <section className="reports-filters">
          ...
          <div className="reports-filters-grid">
            ...
            <div className="reports-field">
              ...
              <div className="reports-input-wrapper">
                ...
                <select
                  id="estado"
                  className="reports-input reports-select"
                  value={estado}
        ...
        <div className="reports-filters-action">
          <span className="material-symbols-outlined reports-pdf-icon">picture_as_pdf</span>
          <p className="reports-action-text">Exportar vista filtrada</p>
          <button className="btn-codffee-primary reports-action-btn" onClick={handleDescargarFiltrado}>
